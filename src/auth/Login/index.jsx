...
const Login = () => {
    ...
    return (
        <div className='content-grid'>
            ...
            bg-muted full-width">
                <div className="max-w-96 bg-background text-gray-600 space-y-5 p-4 md:p-8 shadow-xl border rounded-xl ">
                    ...
                    >
                        ...
                        <button
                            ...
                            className={`w-full px-4 py-2 text-white font-medium rounded-lg ${isSigningIn ? 'bg-gray-300 cursor-not-allowed' : 'bg-primary hover:bg-indigo-700 hover:shadow-xl transition duration-300'}`}
                        >
